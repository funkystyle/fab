angular.module("allUsersModule", ['angularUtils.directives.dirPagination','constantModule', 'toastr', 'personFactoryModule'])
.controller("allUsersCtrl", function ($scope, toastr, mainURL, URL, $state, $stateParams, personFactory) {
    $scope.currentPage = 1;
    $scope.search = {
        search: undefined
    };
